    ...
    _renderView() {
        ...
        new Vue({
            ...
            beforeCreate() {
               ...
               this.loadContentConfig = [{spreadsheet: LABEL_CONFIGURATION_SPREADSHEET, parent: LABELS_KEY}, {spreadsheet: ICON_CONFIGURATION_SPREADSHEET, parent: ICONS_KEY}, {spreadsheet: RANGE_CONFIGURATION_SPREADSHEET}];
